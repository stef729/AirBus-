# -*- coding: utf-8 -*-
"""
Created on Sat Jun 13 08:57:39 2020
...
DATA_DIR = r'D:\Project\AirBus\kaggle-airbus-ship-detection'

# Directory to save logs and trained model
ROOT_DIR = r'D:\Project\AirBus\working'

# Install Matterport's Mask-RCNN model from github
os.chdir(r'D:\Project\AirBus\Mask_RCNN')
# Import Mask RCNN
...
COCO_WEIGHTS_PATH = r'D:\Project\AirBus\mask_rcnn_coco.h5'
...
# 11 training dataset
SEGMENTATION = DATA_DIR + r'\train_ship_segmentations_v2.csv'
...
# [32]  Show few example of ground truth vs. predictions on the validation dataset 
dataset = dataset_val
...
#  [33] Final steps - Create the filtered submission file
# Get filenames of test dataset images
test_image_fps = test_names
DETECTION_TEST_PRED = 'D:/Project/AirBus/kaggle-airbus-ship-detection/ship_detection.csv'
# DETECTION_TEST_PRED =  r'D:\Project\AirBus\kaggle-airbus-ship-detection\sample_submission_v2.csv'
ship_detection = pd.read_csv(DETECTION_TEST_PRED, index_col='id')
print(ship_detection.head())
